...
use crate::profiles::{
    models_app_links::{ApplicationLink, AppLinkResult, CallData, Data, OracleRequest},
...
pub fn get_mock_profile() -> Profile {
    Profile {
        ...
        pictures: Pictures { profile: "".to_string(), cover: "".to_string() },
...
pub fn get_mock_application_link() -> ApplicationLink {
    ApplicationLink {
        ...
        result: AppLinkResult::Success {
            ...
            signature: "9690d734171298eb4cc9636c36d8507535264c1fdb136c9095a6a50c41ccffa".to_string()
        },
        creation_time: "2022-02-21T13:18:57.800827Z".to_string()
    }
}
